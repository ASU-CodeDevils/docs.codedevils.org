...
From _the_ mailbox manager page, select the [![create_new_email](../static/img/dreamhost/email/Picture1.png)](https://panel.dreamhost.com/index.cgi?tree=mail.addresses&current_step=Index&next_step=New) button. Navigate to the _Fully Hosted Email_ section, which will look like:
