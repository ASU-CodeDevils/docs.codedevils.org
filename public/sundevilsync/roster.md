Roster
======
The roster is used to manage CodeDevils membership. You can add/remove/modify memberships, manage officer positions,
and even send messages via email or text.

Disclaimer: members names will not appear in any example images to protect their anonymity.

## Navigate to the Action Center
Navigate to the action center by following [this link](https://asu.campuslabs.com/engage/actioncenter/organization/codedevils)
or by navigating to the [organization home page](https://asu.campuslabs.com/engage/organization/codedevils) and selecting the
**Manage Organization** button in the top right. You must be a registered officer to access the action center.

## Roster Management
From the action center, select the barred icon in the top left:

![action center](https://drive.google.com/uc?id=1ljm4DbHRTHVGe67CL-7utnHm38CI_czE)

And then select **Roster**:

![side drawer](https://drive.google.com/uc?id=1Ani7KY6RojA4DLV1kMECRyE6PPVIwzab)
...
![invite people](https://drive.google.com/uc?id=1SJ_vWBP6k3GWmumWieix2NT-FNsRomxL)
...
Once you have entered all the email address, select the **ADD E-MAIL ADDRESSES** button below the text box. Invitations 
...
![invite people list](https://drive.google.com/uc?id=1T85QueUDExQojXCzrzZ8QEoW96mWqyha)
...
![adding new members](https://drive.google.com/uc?id=1h8k4logOef4l-wfRlgKZprpghj6l3xnu)
...
![new members email](https://drive.google.com/uc?id=1a-y3I-kyaWrKrUXX92iA2Sr_f9n4nIHX)
...
can email them be selecting the check-mark next to their name and selecting the **SEND MESSAGE** button.

### Modify a Membership

#### Modify a Member's Position
...
![modify posiion](https://drive.google.com/uc?id=14Ov1qpkGtXPr-7qQfjZd9HYF6BtMOLEP)

A dialog will appear with all the positions available to be assigned:

![modify position form](https://drive.google.com/uc?id=1f3V3ScFMvM4pbHdNQW1vHBO3FZfl9TZT)
...
![end membership](https://drive.google.com/uc?id=1PelzDQBoVXjPO1Pu99_nltBl3a2FyCam)
...
![manage positions](https://drive.google.com/uc?id=1Ktm0IFkC4ethWSSTzLVuNBT84zFoJqPA)
...
![manage positions](https://drive.google.com/uc?id=1jwrcbj67r8Ox60j4ieZYauaSP6_HOMvg)
...
![manage position form](https://drive.google.com/uc?id=1xfrhePVJmUE3q7NAaePDqgflP3Ik96ck)

##### Position Fields
Fill out the fields as appropriate:
* **Position Name**: The name of the position as it will appear in SunDevilSync.
* **Position Type**: Can be either _Member_ or _Officer_.
* **Show holders of this position on the organization's public roster**: The position and the associated member will
...
![positions list](https://drive.google.com/uc?id=1DVDOwN3JAXgnDWU0-49VY1gnODyaWT-8)

If the name is greyed out, the position is created by default and cannot be modified.

A dialog will appear:

![position edit dialog](https://drive.google.com/uc?id=1uNaHi-qbFbV549QC4-lhmRa2qaPJMzjI)

Modify the [position fields](#position-fields) as needed and select **SAVE** at the bottom of the form.

### Messaging

Although Slack is the preferred method for communicating with members, SunDevilSync offers messaging for sending out
mass messages by either [email](#email) or [SMS](#sms).

#### Email

If the relay you are needing already exists, skip to [Send a Relay Email Message](#send-a-relay-email-message).

##### Create a Relay Address

In order to send emails, a relay address must first be created. Relays are temporary email addresses avaiable for 24
hours and target a certain group of members (i.e. all members or just certain members/positions). To create the relay,
navigate to the [roster management dashboard](https://asu.campuslabs.com/engage/actioncenter/organization/codedevils/roster)
and select [**MESSAGING**](https://asu.campuslabs.com/engage/actioncenter/organization/codedevils/messaging) in the top-right:

![messaging](https://drive.google.com/uc?id=1jGmuKEr8crgdZDSjjqTIV3NDYjqsS9WV)

Select [**CREATE RELAY**](https://asu.campuslabs.com/engage/actioncenter/organization/codedevils/messaging/create). The
following dialog will appear:

![create relay](https://drive.google.com/uc?id=12mG27Ryagip164db9fGf1MDLspWfQzhD)
...
![send all members](https://drive.google.com/uc?id=1WbVUiKjQ_B2eoHly3zo_WZEgAeeJ29bb)

You can save the relay by selecting **GENERATE**. A relay detail dialog will appear with the relay email address:

![relay details](https://drive.google.com/uc?id=1xrZ-mo-cDcc7sfNvOeDcE3kiViWww-4I)

##### Send a Relay Email Message

To send a relay, navigate to the [messaging page](https://asu.campuslabs.com/engage/actioncenter/organization/codedevils/messaging)
...
![relay email](https://drive.google.com/uc?id=1l9qI2mlas5Ys7pULk88yfqB4LlwErdP4)
...
Text messages can be sent to all members who have enabled text messaging in their SunDevilSync account settings. See
[this section](#enabling-text-message-notifications).

Navigate to the [text message page](https://asu.campuslabs.com/engage/actioncenter/organization/codedevils/textmessaging)
...
![text sms](https://drive.google.com/uc?id=1tsQbXL_RtqyqrI0cyNLtdBSzq4DDC3yU)

The text message pane looks like:

![text sms list](https://drive.google.com/uc?id=1beIe1L3K-ewZZyq-3Ta-VUawK5FqTc2u)
...
![create text sms](https://drive.google.com/uc?id=1prIUvnvqwy0hUQvtTEGkOcd0-PXtGIv_)
...
![send text sms](https://drive.google.com/uc?id=1WbVUiKjQ_B2eoHly3zo_WZEgAeeJ29bb)
...
(could be either postmaster@relay.engage.campuslabs.com or postmaster@collegiatelink.mail.campuslabs.com). Text messages
cannot be replied to.

##### Enabling Text Message Notifications
...
![account link](https://drive.google.com/uc?id=1l8W1zJ91nBwBhRHJnp7coGHZicBvoxuv)

Scroll down to the **Text Message Notifications** section:

![phone number](https://drive.google.com/uc?id=1oqqc4gudZeDUjERjLsEA55SdZkeAW6Me)
