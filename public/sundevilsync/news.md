News
====
News articles are public announcements available to members on SunDevilSync and can be used to communicate
general body meetings, webinars, and virtual study halls. Members can view news articles on the
[Engage news article listing](https://asu.campuslabs.com/engage/news).

## Create a News Article
To create a news article by navigating to the [news management dashboard](https://asu.campuslabs.com/engage/actioncenter/organization/codedevils/news),
...
### Section - Create News Article

There are 4 required fields in this section:
1. Title
2. Summary (no more than 250 characters)
3. Body
4. Notify Members - Determines if CodeDevils members are notified when the article is created.
...
1. **Public** - Anyone
2. **Institution** - Students/staff at ASU
3. **Organization** - Only CodeDevils members
4. **Private** - Available only to you (can still be seen by admin users with view/edit access).
...
* Engage News Article Listing - https://asu.campuslabs.com/engage/news
* News Management Dashboard - https://asu.campuslabs.com/engage/actioncenter/organization/codedevils/news
* Organization Action Center - https://asu.campuslabs.com/engage/actioncenter/organization/codedevils